...
@ReadingConverter
public class PGobjectToWorkoutRoundSchemaSnapshotConverter implements Converter<PGobject, WorkoutRoundSchemaSnapshot> {

    private final ObjectMapper mapper;

    public PGobjectToWorkoutRoundSchemaSnapshotConverter(ObjectMapper mapper) {
        this.mapper = mapper;
    }
