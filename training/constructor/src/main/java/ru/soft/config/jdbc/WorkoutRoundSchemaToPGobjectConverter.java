...
@WritingConverter
public class WorkoutRoundSchemaToPGobjectConverter implements Converter<WorkoutRoundSchemaSnapshot, PGobject> {

    private final ObjectMapper mapper;

    public WorkoutRoundSchemaToPGobjectConverter(ObjectMapper mapper) {
        this.mapper = mapper;
    }
