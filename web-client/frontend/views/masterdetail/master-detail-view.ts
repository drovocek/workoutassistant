...
import SamplePerson from 'Frontend/generated/ru/soft/webclient/data/entity/SamplePerson';
import SamplePersonModel from 'Frontend/generated/ru/soft/webclient/data/entity/SamplePersonModel';
                                ...
                                ${columnBodyRenderer<SamplePerson>((item) =>
                                        item.important
                                                ? html`
                                                    <vaadin-icon
                                                            icon="vaadin:check"
                                                            style="width: var(--lumo-icon-size-s); height: var(--lumo-icon-size-s); color: var(--lumo-primary-text-color);"></vaadin-icon>`
                                                : html`
                                                    <vaadin-icon
                                                            icon="vaadin:minus"
                                                            style="width: var(--lumo-icon-size-s); height: var(--lumo-icon-size-s); color: var(--lumo-disabled-text-color);"></vaadin-icon>`
                                )}
                        ></vaadin-grid-column>
                    </vaadin-grid>
                </div>
                    ...
                    <div class="editor">
                        ...
                        >
                            ...
                            <vaadin-text-field
                                    label="Occupation"
                                    id="occupation"
                                    ${field(this.binder.model.occupation)}></vaadin-text-field>
                            <vaadin-checkbox id="important" ${field(this.binder.model.important)}
                                             label="Important"></vaadin-checkbox>
                        </vaadin-form-layout>
                    </div>
