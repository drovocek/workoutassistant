...
@FeignClient(name = "trainingsession",
        url = "${feign.url}#{T(ru.soft.common.AppApi.TrainingSessions).URL}",
        fallbackFactory = ApiControllerFallbackFactory.class)
public interface TrainingSessionClient extends ApiController<TrainingSessionTo> {
}